...
LOG_MODULE_REGISTER(iwdg_stm32);
...
#elif defined(CONFIG_SOC_SERIES_STM32WB0)
		/* On STM32WB0, IWDG cannot be paused when CPU is halted by debugger */
		return -ENOTSUP;
#else
...
#ifdef CONFIG_SOC_SERIES_STM32WB0
	/**
